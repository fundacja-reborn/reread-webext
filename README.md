...
- **TSV import and export.** Move vocabulary to Anki or between devices; importing the same file twice never duplicates a phrase. In the file's meaning cell a semicolon followed by a space separates meanings, and a semicolon without a space stays inside its meaning. When you type several meanings of your own at once - in the phrases page's field or in the edit box - a semicolon separates them; a dictionary's own line with a semicolon in it stays one meaning until you edit that line.
